...
8. `state-machines.v0.6.schema.json`（Compiler 仍接受保留的 v0.1 無條件、v0.2 bounded-condition、v0.3 deterministic-timer、v0.4 bounded-reaction 與 v0.5 single-active-leaf hierarchy 來源）
