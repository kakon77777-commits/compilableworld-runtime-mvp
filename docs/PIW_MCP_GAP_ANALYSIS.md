...
- **Runtime baseline:** CompilableWorld `0.1.1`, current local suite `320/320` plus 46 subtests passing
...
- historical 113-test baseline remains green; current local suite is 320/320 plus 46 subtests
