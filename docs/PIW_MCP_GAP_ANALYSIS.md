...
- **Runtime baseline:** CompilableWorld `0.1.1`, current local suite `329/329` plus 58 subtests passing
...
- historical 113-test baseline remains green; current local suite is 329/329 plus 58 subtests
