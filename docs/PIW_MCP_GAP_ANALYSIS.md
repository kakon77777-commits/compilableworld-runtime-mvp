...
- **Runtime baseline:** CompilableWorld `0.1.1`, current local suite `324/324` plus 52 subtests passing
...
- historical 113-test baseline remains green; current local suite is 324/324 plus 52 subtests
