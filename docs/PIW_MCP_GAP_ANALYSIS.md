...
- **Runtime baseline:** CompilableWorld `0.1.1`, current local suite `336/336` plus 76 subtests passing
...
- historical 113-test baseline remains green; current local suite is 336/336 plus 76 subtests
