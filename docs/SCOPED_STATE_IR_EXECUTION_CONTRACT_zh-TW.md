...
- Action-scope、可中斷／取消／補償的複合行為狀態機；
...
驗證基線由 `tests/test_scoped_state_machine.py` 覆蓋五種 owner、跨層 chaining、terminal FSM 到 Quest、Snapshot、Replay、Studio projection、legacy seed 相容與 reaction rollback；完整測試為 265/265。
