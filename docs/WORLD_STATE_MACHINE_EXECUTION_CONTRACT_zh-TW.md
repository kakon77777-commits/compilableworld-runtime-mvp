...
- Kernel Action lifecycle：`action.scheduled`、`action.branch_selected`、`action.child_started`、`action.child_completed`、`action.child_failed`、`action.progressed`、`action.retry_scheduled`、`action.started`、`action.completed`、`action.cancelled`、`action.interrupted`、`action.failed`；
