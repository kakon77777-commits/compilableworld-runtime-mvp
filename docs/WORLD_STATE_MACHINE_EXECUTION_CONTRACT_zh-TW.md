...
- Kernel Action lifecycle：`action.scheduled`、`action.progressed`、`action.retry_scheduled`、`action.started`、`action.completed`、`action.cancelled`、`action.interrupted`、`action.failed`；
