...
own duration, phase-gate, retry, child-step, or interruption rules. Older source
versions remain compiler inputs; the current contract adds bounded primitive
child Actions without introducing recursion, arbitrary effects, or graph DSLs.
"""
...
ACTION_BEHAVIOR_FORMAT = "compilableworld.action-behaviors/v0.5"
...
ACTION_BEHAVIOR_SCHEMA_ID = "compilableworld.schema/action-behaviors/v0.5"
